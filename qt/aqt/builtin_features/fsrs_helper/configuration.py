from aqt.builtin_features import load_fsrs_config, save_fsrs_config, on_fsrs_config_change
...
def load_config():
    return load_fsrs_config()


def save_config(data):
    save_fsrs_config(data)


def run_on_configuration_change(function):
    on_fsrs_config_change(function)
