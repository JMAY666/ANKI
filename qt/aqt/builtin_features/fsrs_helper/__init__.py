...
from aqt.builtin_features import fsrs_user_files
...
from aqt.builtin_features import show_fsrs_settings

menu_for_helper = mw.form.menuTools.addMenu(t("fsrs-helper"))
menu_for_helper.setObjectName("builtinFsrsHelperMenu")
menu_for_helper.addAction("设置…", show_fsrs_settings)
